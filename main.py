    ...
    while True:
        ...
        if amount.isdigit():
            ...
            if amount > 0:
                ...
                print("amout must be greather then 0")
        else:
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"you do not have enought that ammount, your current balance is ${balance}")
        else:
            break
...
def main():
    ...
    while True:
        ...
        answer = input("press enter to play. (q to quick)")
        if answer == "q":
            break
